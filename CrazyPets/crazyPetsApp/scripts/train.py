...
def get_data():
    train = pd.read_csv('/home/crazy_pets/CrazyPets/CrazyPets/crazyPetsApp/input/train.csv')
    # 4人のscoreの平均を取る
    train = train.groupby(
...
if __name__ == '__main__':
    ...
    pickle.dump(models, open('/home/crazy_pets/CrazyPets/CrazyPets/crazyPetsApp/model/model.pkl', 'wb'))